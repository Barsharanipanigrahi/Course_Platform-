...
import { LayoutDashboard, BookOpen, MessageSquare, Users, ArrowLeft, LogOut, GraduationCap } from 'lucide-react';

const SIDEBAR_LINKS = [
  { to: '/admin',         label: 'Dashboard', icon: <LayoutDashboard size={17}/> },
  { to: '/admin/course',  label: 'Courses',   icon: <BookOpen size={17}/>        },
  { to: '/admin/contact', label: 'Contacts',  icon: <MessageSquare size={17}/>   },
  ...
  return (
    <>
      <style>{`
        ...
        .sb-logo-txt{font-family:'Playfair Display',serif;font-size:1.05rem;font-weight:800;color:#fafafa;line-height:1.1;}
      ...
      <div className="sb">
        ...
        <div className="sb-top">
          <div className="sb-logo">
            ...
            <div><div className="sb-logo-txt">EduLearn</div><div className="sb-logo-sub">Admin Panel</div></div>
          </div>
        </div>
        <nav className="sb-nav">
          ...
          <Link to="/" className="sb-back"><ArrowLeft size={15}/>Back to Site</Link>
        </nav>
